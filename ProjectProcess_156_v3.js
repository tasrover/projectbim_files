...
function Gantt_grid_click(id) {
    ...
    for (x in task.section) {
        var positon = all_section_ids.indexOf(task.section[x]);
...
function GanttClickEvents(date) {
    ...
    if (section_list != "") {
        ...
        for (x in section_list) {
            var positon = all_section_ids.indexOf(section_list[x]);
            sectionElements.push.apply(sectionElements, all_section_elements[positon]);
        }
        viewer3D1.getModel().overrideComponentsColorById(sectionElements, color0);
        viewer3D1.render();
    ...
    if (week_finished_section != "") {
        ...
        for (x in week_finished_section) {
            var positon = all_section_ids.indexOf(week_finished_section[x]);
            sectionElements.push.apply(sectionElements, all_section_elements[positon]);
        }
        viewer3D1.getModel().overrideComponentsColorById(sectionElements, color0);
        viewer3D1.render();
